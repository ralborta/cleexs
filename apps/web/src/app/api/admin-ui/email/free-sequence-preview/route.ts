...
export async function GET(request: Request) {
  ...
  try {
    const res = await forwardToCleexsApi('/api/admin/email/free-sequence-preview', { method: 'GET' });
...
export async function PATCH(request: Request) {
  ...
  try {
    const res = await forwardToCleexsApi('/api/admin/email/free-sequence-preview/config', {
      method: 'PATCH',
