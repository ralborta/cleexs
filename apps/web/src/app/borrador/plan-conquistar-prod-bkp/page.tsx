...
/**
 * BACKUP de la landing /plan-conquistar previa al reemplazo por la versión personalizada.
 * Ruta: /borrador/plan-conquistar-prod-bkp
 * Fecha backup: 2026-08-10
 */
export const metadata: Metadata = {
  title: 'BKP · Plan Conquistar (producción anterior) | Cleexs',
  description: 'Backup de la landing Plan Conquistar que estaba en producción antes del reemplazo.',
...
export default function PlanConquistarProdBackupPage() {
  return (
    <main className="min-h-[calc(100vh-72px)] bg-gradient-to-b from-violet-50/60 via-white to-white pb-[calc(5.5rem+env(safe-area-inset-bottom))] sm:pb-0">
      <div className="border-b border-amber-200 bg-amber-50 px-4 py-2 text-center text-xs font-medium text-amber-900 sm:text-sm">
        Backup · landing de producción anterior · la live está en{' '}
