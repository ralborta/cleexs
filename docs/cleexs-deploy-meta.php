  ...
  <main>
    <section class="hero" id="cta">
      <div class="wrap">
        ...
        <p class="hero-prompt">👉 Ingresá el sitio web de tu empresa y descubrilo gratis.</p>
    ...
    <section class="section-discover" id="producto">
      <div class="wrap discover">
        ...
        <figure class="report-preview">
          <figcaption class="report-caption">Así se verá tu informe</figcaption>
          <div class="report-float">
            <img
              src="https://app.cleexs.net/inicio/assets/diagnostico-preview-cleexs-score.jpg"
              alt="Ejemplo real de Cleexs Score — así se verá tu informe"
              width="1024"
              height="859"
              loading="lazy"
              decoding="async"
