...
if (!is_dir($dir) && !mkdir($dir, 0755, true)) {
  ...
  exit("ERROR: no se pudo crear meta/\n");
}
$html = <<<'CLEEXS_LANDING'
<!DOCTYPE html>
<!-- cleexs-landing-build: 2026-08-25T18:38:45Z landing=meta-v1 path=/meta brand-only no-faq score-preview-v2 -->
<html lang="es">
<head>
  <meta charset="UTF-8" />
  ...
  <header class="site-header">
    <div class="wrap header">
      <a class="brand" href="https://cleexs.net/">
        <img src="https://cleexs.net/inicio/assets/CleexsMark.svg" alt="" width="28" height="28" />
        <span>Cleexs</span>
      </a>
    </div>
  </header>
...
<script>
  window.__CLEEXS_LANDING_PATH__ = '/meta';
  window.__CLEEXS_LANDING_KEY__ = 'meta-v1';
</script>
